...
1. Copilot will read the skill, create the assignment, and run the bundled scripts.
   ...
   <img width="380" alt="Copilot reading the new-assignment SKILL.md file" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/skill-being-used.png?raw=true" />

   Accept any confirmation prompts to let it continue.

   <img width="380" alt="Copilot asking for confirmation to run node scripts" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/node-confirmation.png?raw=true" />
