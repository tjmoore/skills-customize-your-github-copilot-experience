...
<img width="600" alt="screenshot of homework website" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/homework-website-screenshot.png?raw=true" />
...
1. Notice that Copilot uses your custom instructions as a reference in the response.
   ...
   <img width="504" height="183" alt="Copilot response showing custom instructions reference" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/copilot-custom-instructions-reference.png?raw=true" />
