...
1. Select your custom agent from the agent dropdown list.
   ...
   <img width="379" height="218" alt="copilot agent: assignment brainstorming agent selected" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/custom-agent-dropdown-selection.png?raw=true" />
...
1. Once the agent recommends an assignment, click the **Create this assignment** button to hand off to Agent Mode for implementation.
   ...
   <img width="380" alt="Create this assignment handoff button" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/handoff-button.png?raw=true" />
