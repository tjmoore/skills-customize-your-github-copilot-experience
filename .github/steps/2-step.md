...
1. Observe how Copilot references the general project instructions and the assignment specific instruction files.
   ...
   <img width="600" alt="screenshot of Copilot chat showing attached references" src="https://github.com/tjmoore/skills-customize-your-github-copilot-experience/blob/main/.github/images/copilot-chat-reviews-instructions.png?raw=true" />
